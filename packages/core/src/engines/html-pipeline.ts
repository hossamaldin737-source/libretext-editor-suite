...
): { id: string; type: string; title: string; createdAt: string; updatedAt: string; version: number; data: RichTextData } {
 ...
 */
export function exportDocumentToCleanHtml(document: { title?: string; type: string; data: unknown }): string {
