 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * 📄 الملف: react-adapter.ts
 * 📂 المسار: packages/adapters/src/react/react-adapter.ts
 * 🎯 الهدف الرئيسي: محور React لتحرير المستندات.
 * 📋 المعايير:
 ...
 */
export class ReactAdapter implements EditorAdapter {
  ...
  private render(): void {
    ...
    const html = this.doc.content.map((block) => this.renderBlock(block)).join('');
